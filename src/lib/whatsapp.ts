...
export async function logWhatsAppTransmission(
  entry: Omit<WhatsAppLogEntry, "id" | "timestamp">,
) {
  ...
  if (isConfigured) {
    try {
      ...
      if (response.ok && (responseData?.messages || responseData?.success)) {
        ...
        const errorMsg =
          responseData?.error?.message || "Failed API transmission";
    ...
    console.log(
      "\x1b[32m│\x1b[1;37m             💬 WHATSAPP NOTIFICATION DISPATCH          \x1b[0m\x1b[32m│\x1b[0m",
    );
    console.log(
      "\x1b[32m├────────────────────────────────────────────────────────┤\x1b[0m",
    );
    console.log(
      `\x1b[32m│\x1b[0m \x1b[1;30mStatus:\x1b[0m    \x1b[1;32mSIMULATED SENT                              \x1b[0m\x1b[32m│\x1b[0m`,
    );
    console.log(
      `\x1b[32m│\x1b[0m \x1b[1;30mTimestamp:\x1b[0m \x1b[36m${timestamp.substring(0, 24)} \x1b[0m                  \x1b[32m│\x1b[0m`,
    );
    console.log(
      `\x1b[32m│\x1b[0m \x1b[1;30mRecipient:\x1b[0m \x1b[1;33m${phone.padEnd(44)} \x1b[0m\x1b[32m│\x1b[0m`,
    );
    console.log(
      "\x1b[32m├────────────────────────────────────────────────────────┤\x1b[0m",
    );
    console.log(
      "\x1b[32m│\x1b[0m \x1b[1;34mMessage Payload:\x1b[0m                                       \x1b[32m│\x1b[0m",
    );
    console.log(
    ...
    for (const line of lines) {
      ...
      console.log(
        `\x1b[32m│\x1b[0m \x1b[37m${cleanLine.padEnd(54)}\x1b[0m \x1b[32m│\x1b[0m`,
      );
    }
