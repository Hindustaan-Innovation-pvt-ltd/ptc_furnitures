    ...
    <div className="mx-auto max-w-7xl px-4 py-20 text-center transition-colors duration-300 sm:px-6 lg:px-8 lg:py-28">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {reviews.map((review, index) => (
          <div
            key={index}
            className="flex flex-col gap-4 rounded-lg border border-slate-200/80 bg-white p-5 text-left shadow-md shadow-black/5 dark:border-white/10 dark:bg-[#111318] dark:shadow-black/20 sm:p-6"
          >
