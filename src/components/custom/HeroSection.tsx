...
export default function HeroSection() {
  ...
  return (
    <main className="pt-8 sm:pt-12 lg:pt-16 max-w-5xl mx-auto overflow-hidden">
      <div className="relative w-full px-6 sm:px-12 py-16 sm:py-20 md:py-24">
        ...
        <h1 className="flex flex-col gap-4 sm:gap-6 md:gap-8 font-sans font-black text-slate-950 dark:text-white select-none tracking-tight">
          {/* Row 1: THE MASTERS [Pill-Image-1] (slides from Left) */}
          <motion.div 
            initial={{ opacity: 0, x: -80 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.85, ease: [0.16, 1, 0.3, 1] }}
            className="flex flex-wrap items-center gap-x-4 sm:gap-x-6 gap-y-3 text-4xl sm:text-6xl md:text-7xl lg:text-[5vw] leading-[1.05]"
          >
          ...
          <motion.div 
            ...
            className="text-4xl sm:text-6xl md:text-7xl lg:text-[5vw] leading-[1.05]"
          >
            <span>OF </span>
