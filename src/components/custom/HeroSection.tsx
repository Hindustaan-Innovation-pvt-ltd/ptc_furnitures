      ...
      <div className="relative w-full px-3 sm:px-8 lg:px-12 py-12 sm:py-20 md:py-24">
        ...
        <h1 className="flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8 font-sans font-black text-slate-950 dark:text-white select-none tracking-tight">
          ...
          >
            ...
            <div className="relative inline-flex rounded-full overflow-hidden aspect-[2.1/1] w-38 sm:w-32.5 md:w-42.5 lg:w-55 xl:w-62.5 border border-slate-200/60 dark:border-white/10 shadow-lg bg-slate-100 dark:bg-slate-900 shrink-0">
          ...
          <motion.div
            ...
            className="flex items-center justify-center gap-x-2.5 sm:gap-x-6 text-3xl sm:text-5xl md:text-6xl lg:text-[76px] xl:text-[80px] leading-[1.05] whitespace-nowrap"
          >
            <div className="relative inline-flex rounded-full overflow-hidden aspect-[2.6/1] w-52 sm:w-40 md:w-55 lg:w-70 xl:w-100 border border-slate-200/60 dark:border-white/10 shadow-lg bg-slate-100 dark:bg-slate-900 shrink-0">
              <AnimatePresence initial={false} mode="popLayout">
                <motion.img
