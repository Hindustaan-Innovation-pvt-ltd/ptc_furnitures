            ...
            <div className="mt-7 flex items-center gap-3">
              {
                [
                  {
                    icon: <svg width="48" height="48" className="size-5 stroke-slate-600" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    ,
                    link: "https://www.instagram.com/ptcfurniture/",
                  },
                  {
                    icon: <svg
                      width="512"
