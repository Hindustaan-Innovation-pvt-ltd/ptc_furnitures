...
export default async function Home({
  ...
  return (
    <div className="min-h-screen bg-[#f8f8f8] text-slate-900 dark:bg-[#08090d] dark:text-slate-100 transition-colors duration-300">
      <Navigation />
      <section
        aria-label="ptc furniture app"
        className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-12 lg:pb-24"
      >
        <main className="pt-10 sm:pt-12 lg:pt-20">
          <div className="grid place-content-center">
            <div className="mb-10 flex flex-col items-center gap-5 text-center sm:mb-12 lg:gap-8">
              <h1 className="max-w-2xl text-4xl font-semibold text-slate-900 dark:text-slate-50 sm:text-5xl lg:text-6xl lg:leading-[1.05]">
                Discover the most{" "}
                <span className="text-red-800 dark:text-red-600 italic">
                  considered pieces.
                </span>
              </h1>
              <span className="max-w-md text-sm font-medium leading-6 text-slate-600 dark:text-slate-300 sm:text-base">
                Furniture crafted for considered living — built to endure,
                designed to inspire.
              </span>
              <Button
                className="rounded-full px-8 py-4 shadow-lg shadow-black/10 dark:shadow-black/30 sm:px-12 lg:px-10"
                asChild
              >
                <Link
                  href="/collections"
            ...
            <Image
              src="/banner.png"
              alt="PTC Furniture Banner"
              width={1200}
              height={600}
              priority
              className="mt-8 w-full drop-shadow-2xl sm:-mt-4 lg:-mt-12"
              style={{ height: "auto" }}
            />
          </div>
        </main>
