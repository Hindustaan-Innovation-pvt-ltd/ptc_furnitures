      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end items-center h-full">
            ...
            >
              <img
                src="/upload/1f84a727-7aa9-4e44-aa0d-2cf09a0eb980.webp"
          ...
          <div className="border-t border-b border-gray-300 dark:border-gray-700">
            <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 py-12 md:grid-cols-2 xl:grid-cols-3">
              {[
                {
                  icon: (
                    <div className="relative p-6 rounded-full bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/40 text-red-600 dark:text-red-500 transition-colors duration-300 group-hover:bg-red-100 dark:group-hover:bg-red-950/40">
                      <ShieldCheck className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24" strokeWidth={1.2} />
                    </div>
                  ),
                  title: "Quality",
                  description:
                ...
                },
                {
                  icon: (
                    <div className="relative p-6 rounded-full bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/40 text-red-600 dark:text-red-500 transition-colors duration-300 group-hover:bg-red-100 dark:group-hover:bg-red-950/40">
                      <Tag className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24" strokeWidth={1.2} />
                    </div>
                  ),
                  title: "Affordable",
                  description:
                ...
                },
                {
                  icon: (
                    <div className="relative p-6 rounded-full bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/40 text-red-600 dark:text-red-500 transition-colors duration-300 group-hover:bg-red-100 dark:group-hover:bg-red-950/40">
                      <Armchair className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24" strokeWidth={1.2} />
                    </div>
                  ),
                  title: "Comfortable",
                  description:
